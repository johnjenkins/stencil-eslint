...
export function isPrivate(originalNode) {
...
export function getDecoratorList(originalNode) {
    const decorators = ts.canHaveDecorators(originalNode)
        ? ts.getDecorators(originalNode)
        : undefined;
    return decorators;
}
export function getDecorator(node, decoratorName) {
    if (decoratorName) {
...
export function parseDecorator(decorator) {
...
export function isDecoratorNamed(propName) {
    return (dec) => {
